...
/*   Updated: 2024/10/24 23:49:32 by piesito          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 	else if (c == 'p')
		...
		i += ft_print_dgt(va_arg(args, int));
	else if (c == 'u')
		i += ft_print_udt(va_arg(args, unsigned int));
	else if (c == 'x' || c == 'X')
		i += ft_print_udt(va_arg(args, unsigned int), c);
	else if (c == '%')
		i += write(1, "%", 1);
	else
		i += write(1, &c, 1);
